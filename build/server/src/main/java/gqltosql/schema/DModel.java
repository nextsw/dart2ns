...
public class DModel<T> {
	...
	public <R> DPrimField<T, R> addEnum(String name, int index, String column, int enumClss, Function<T, R> getter,
	...
	public <R> DPrimCollField<T, R> addEnumCollection(String name, int index, String column, String collTable,
			int enumClss, Function<T, List<R>> getter, BiConsumer<T, List<R>> setter) {
	...
	public <R> DDocCollField<T, R> addDocReferenceCollection(String name, int index, String column, String collTable,
			boolean child, DModel<?> ref, Function<T, List<R>> getter, BiConsumer<T, List<R>> setter,
			Function<T, List<String>> docGetter, BiConsumer<T, List<String>> docSetter) {
		DDocCollField<T, R> field = new DDocCollField<T, R>(this, index, name, column, child, collTable, ref, getter,
				setter, docGetter, docSetter);
		addField(field);
		return field;
	}
