...
//	}
	...
	public static boolean containsIgnoreCase(String on, String other, long startIndex) {
		int index = (int) startIndex;
		return Pattern.compile(other.toLowerCase()).matcher(on.toLowerCase().substring(index)).find();
	}
